...
function createBrickConfig(col: number, row: number, health: number, color?: string): BrickConfig {
  return { col, row, health, color };
}

describe('Brick', () => {
  describe('constructor', () => {
    it('should initialize with correct position', () => {
      const brick = new Brick(createBrickConfig(2, 3, 3));
    ...
    it('should initialize with correct dimensions', () => {
      const brick = new Brick(createBrickConfig(0, 0, 3));
  ...
  describe('takeDamage', () => {
    ...
    it('should reduce health by multiple damage', () => {
      const brick = new Brick(createBrickConfig(0, 0, 5));
      brick.takeDamage(2);
      expect(brick.getHealth()).toBe(3);
    });
  ...
  describe('getHealthPercentage', () => {
    ...
    it('should return 0.5 when at half health', () => {
      const brick = new Brick(createBrickConfig(0, 0, 4));
      brick.takeDamage(2);
  ...
  describe('getBounds', () => {
    ...
    it('should return bounds for different grid position', () => {
      const brick = new Brick(createBrickConfig(1, 1, 1));
      const bounds = brick.getBounds();
  ...
  describe('getColor', () => {
    ...
    it('should return different colors for different max health values', () => {
      const brick1 = new Brick(createBrickConfig(0, 0, 1));
      const brick2 = new Brick(createBrickConfig(0, 0, 2));
    ...
    it('should return yellow color when health between 33% and 66%', () => {
      const brick = new Brick(createBrickConfig(0, 0, 10));
